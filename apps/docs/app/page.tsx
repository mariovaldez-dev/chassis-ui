...
const FAQ = [
  ...
  { id: "q3", trigger: "¿Es compatible con Next.js?", content: "Totalmente. Los componentes llevan 'use client' donde lo necesitan. Para Next.js 15+, puedes importarlos directamente." },
];
      ...
      <main className="mx-auto max-w-5xl space-y-20 px-6 py-20">
        ...
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col items-center gap-3 sm:flex-row">
            ...
            <Link
              href="/docs"
              className="inline-flex h-10 items-center gap-1.5 rounded-md border border-border bg-transparent px-6 text-sm font-medium text-foreground transition-colors hover:bg-muted"
            >
              Ver documentación
            ...
            <div className="rounded-xl border bg-card p-6 space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {([
                  ...
                  <Button key={variant} size="sm" variant="outline" onClick={() => toast({ title: label, description: desc, variant })}>
                    {label}
                  </Button>
                ))}
              </div>
            ...
            <div className="rounded-xl border bg-card p-6 space-y-4">
              ...
              <Dialog isOpen={dialogOpen} onClose={() => setDialogOpen(false)}>
                ...
                <DialogFooter>
                  ...
                  <Button onClick={() => { setDialogOpen(false); toast({ title: "Acción confirmada", variant: "success" }); }}>
                    Confirmar
                  </Button>
                </DialogFooter>
              </Dialog>
          ...
          <div className="rounded-xl border bg-card p-6">
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex -space-x-2 ml-4">
                ...
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-muted ring-2 ring-background text-xs text-muted-foreground">+5</div>
              </div>
            </div>
          </div>
        </Section>
              ...
              <div className="inline-flex items-center rounded-xl border bg-background shadow-sm px-2 py-1.5 gap-0.5">
                ...
                {getPages(paginaDefault, 10).map((p, i) =>
                  p === "e" ? (
                    ...
                    <PaginationLink key={p} isActive={p === paginaDefault} onClick={() => setPaginaDefault(p)} className="h-8 w-8 rounded-lg text-xs">
                      {p}
                    </PaginationLink>
                  )
                )}
                ...
                <PaginationContent className="gap-1">
                  ...
                  {[1, 2, 3, 4, 5].map((p) => (
                    <PaginationItem key={p}>
                      <PaginationLink isActive={p === 1} className={`h-8 w-8 rounded-full text-xs ${p === 1 ? "bg-primary text-primary-foreground" : ""}`} onClick={() => {}}>
                        {p}
                      </PaginationLink>
                    </PaginationItem>
                  ))}
